...
class FxpInboundModel {
    ...
    async fxQuoteRequest(originalQuoteRequestHeaders, originalQuoteRequest) {
        try {
            ...
            this.domainEventLogger.logDomainEvent(DomainEvents.FX_QUOTE_A_RECEIVED, originalQuoteRequest.transactionId, originalQuoteRequest);
            ...
            this.domainEventLogger.logDomainEvent(DomainEvents.FX_QUOTE_B_CREATED, originalQuoteRequest.transactionId, secondStageComposedQuote);
            ...
            this.domainEventLogger.logDomainEvent(DomainEvents.FX_QUOTE_B_SENT, originalQuoteRequest.transactionId, secondStageComposedQuote);
    ...
    async handleSecondStageQuoteResponse(cn, msg, secondStageQuote, originalQuoteSourceFspId, originalQuoteDestinationFspId, originalQuoteRequest, secondStageQuoteSourceFsp, secondStageQuoteDestinationFsp) {
        ...
        this.domainEventLogger.logDomainEvent(DomainEvents.FX_QUOTE_B_RESPONSE_RECEIVED, originalQuoteRequest.transactionId, secondStageQuoteResponse);
        ...
        this.domainEventLogger.logDomainEvent(DomainEvents.FX_QUOTE_A_RESPONSE_CREATED, originalQuoteRequest.transactionId, composedResponseToOriginalQuote);
        ...
        this.domainEventLogger.logDomainEvent(DomainEvents.FX_QUOTE_A_RESPONSE_SENT, originalQuoteRequest.transactionId, composedResponseToOriginalQuote);
    }
    ...
    async fxpTransfer(prepareRequest, prepareRequestSourceFspId, destinationFspId, quoteData) {
        ...
        this.domainEventLogger.logDomainEvent(DomainEvents.FX_TRANSFER_A_RECEIVED, prepareRequest.transferId, prepareRequest);
        ...
        this.domainEventLogger.logDomainEvent(DomainEvents.FX_TRANSFER_B_CREATED, prepareRequest.transferId, secondStageTransfer);
        ...
        this.domainEventLogger.logDomainEvent(DomainEvents.FX_TRANSFER_B_SENT, prepareRequest.transferId, secondStageTransfer);
    }
    ...
    async createFxpTransferResponseListener(prepareRequest, prepareRequestSourceFspId, quoteData, composedSecondStageTransfer) {
        ...
        const secondStageTransferResponseHandler = async (cn, msg) => {
            ...
            if (sourceFspId === quoteData.secondStageQuoteDestinationFsp && destinationFspId === quoteData.secondStageQuoteSourceFsp) {
                ...
                this.domainEventLogger.logDomainEvent(DomainEvents.FX_TRANSFER_B_FULFILMENT_RECEIVED, prepareRequest.transferId, secondStageTransferResponse);
            } else {
            ...
            this.domainEventLogger.logDomainEvent(DomainEvents.FX_TRANSFER_B_PAYEE_TRANSFER_COMMITTED, prepareRequest.transferId, secondStageTransferResponse);
            ...
            this.domainEventLogger.logDomainEvent(DomainEvents.FX_TRANSFER_B_PAYEE_TRANSFER_COMMITTED_ACK, prepareRequest.transferId, secondStageTransferResponse);
            ...
            this.domainEventLogger.logDomainEvent(DomainEvents.FX_TRANSFER_A_FULFILMENT_CREATED, prepareRequest.transferId, transferFulfilment);
            ...
            this.domainEventLogger.logDomainEvent(DomainEvents.FX_TRANSFER_A_FULFILMENT_SENT, prepareRequest.transferId, transferFulfilment);
    ...
    async createOriginalTransferResponseListener(prepareRequest, prepareRequestSourceFspId, quoteData) {
        ...
        const originalTransferResponseHandler = async (cn, msg) => {
            ...
            this.domainEventLogger.logDomainEvent(DomainEvents.FX_TRANSFER_A_PAYER_TRANSFER_COMMITTED, prepareRequest.transferId, originalTransferResponse);

            await this.forwardFulfilmentToBackend(originalTransferResponse, prepareRequestSourceFspId, prepareRequest.transferId);
            this.domainEventLogger.logDomainEvent(DomainEvents.FX_TRANSFER_A_PAYER_TRANSFER_COMMITTED_ACK, prepareRequest.transferId, originalTransferResponse);
